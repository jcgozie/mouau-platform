...
export default function CredentialRequestClient({ personaLabel }: { personaLabel: string }) {
  ...
  return (
    <PortalShell personaLabel={personaLabel}>
      <h2 className="font-display text-xl font-medium text-forest">Transcript Requests</h2>
      <p className="mt-2 max-w-prose text-sm text-ink/60">
        This is the exact same request system and verification page
        Students use — Alumni status doesn't get a second, parallel
        transcript path.
      </p>
      {!code ? (
